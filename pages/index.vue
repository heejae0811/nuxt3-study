...
<template>
	<section>
		<h1 class="mt-6 mb-12 md:mt-10 text-5xl font-bold text-center">
			To Do List
		</h1>

		<form class="mb-6" @submit.prevent="addToDo()">
			<label for="toDo" class="block mb-3 text-xl font-bold"> New To Do </label>
			...
			<div class="flex gap-3 md:gap-5">
				...
				/>
				<button class="w-1/4 bg-teal-600 hover:bg-teal-500 transition rounded">
					추가하기
				</button>
			</div>
		</form>
